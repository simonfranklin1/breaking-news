    ...
    return (
        <div className="flex items-start gap-4">
            ...
            <div className='flex flex-col  bg-slate-200 rounded-lg px-5 py-2 gap-4 relative'>
                ...
                {comment.comment}
                <button className={`absolute top-[8px] right-[-35px] duration-200 hover:scale-105 hover:text-red-500 text-lg ${comment.userId !== user.id ? "hidden" : ""}`} onClick={() => handleDeleteComment(comment.idComment)}>
