...
const Card = ({ id, title, text, banner, likes, comments, creator, top = false }) => {
  ...
  return (
    <div onClick={handlePost}>
      <div className={`font-news flex flex-col sm:shadow-md rounded-md bg-white overflow-hidden duration-300 sm:hover:shadow-xl sm:hover:scale-[1.02] cursor-pointer lg:w-full h-full ${ top ? "lg:h-[375px]" : "lg:h-[235px] h-[450px] max-h-[450px]"}`}>
